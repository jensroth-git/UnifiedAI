...
### Added
- Video message support for Google Gemini models
- `BaseVideoMessage` type for video content
- Video utility functions for easier file handling
- Comprehensive video examples and documentation
